...
module Shopqi
  class Application < Rails::Application
    ...
    config.active_record.observers = :shop_observer, :smart_collection_observer, :product_observer, :theme_observer, :order_observer,:activity_observer, :webhook_observer
    ...
    # Disable automatic stylesheet/javascript generation
