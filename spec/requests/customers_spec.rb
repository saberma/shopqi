  ...
  describe "GET /customers/new" do
    ...
    it "should be save" do
      within '#new-customer-screen' do
        ...
        select '北京市', form: 'customer[addresses_attributes][][province]'
        select '市辖区', form: 'customer[addresses_attributes][][city]'
        select '东城区', form: 'customer[addresses_attributes][][district]'
    ...
    describe "Edit" do
      ...
      it "should be save" do
        ...
        within '#edit-customer-screen' do
          ...
          select '北京市', from: 'province'
          select '市辖区', from: 'city'
          select '东城区', from: 'district'
          fill_in '地址', with: '中关村311'
          fill_in '邮编', with: '517058'
          uncheck 'customer[accepts_marketing]'
          fill_in 'customer[note]', with: '开发者'
