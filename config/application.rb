...
module Shopqi
  class Application < Rails::Application
    ...
    config.action_view.javascript_expansions[:admin] = %w(jquery.min jquery-ui-1.8.11.custom.min rails handlebars underscore-min backbone-min backbone.rails jquery.tmpl.min rails.validations jquery.blockUI plugins admin_application )
